---
name: accessibility
description: WCAG 2.2 / Lighthouse a11y audit and fixes — alt text, keyboard, contrast, ARIA, focus. Use for accessibility, a11y, screen reader, WCAG.
source: web-quality
runAs: inline
invocation: auto
allowed-tools: [read_file, write_file, edit_file, multi_edit, list_dir, search_files, run_command, http_get, screenshot_url, inspect_render, post_message, run_skill, create_bug_ticket]
agents: [heiji, kid, agasa, haibara]
---

# Accessibility (a11y)

> Source: addyosmani/web-quality-skills · Verify Live URL with `screenshot_url` / `inspect_render`; file gaps via `create_bug_ticket` when out of scope.
